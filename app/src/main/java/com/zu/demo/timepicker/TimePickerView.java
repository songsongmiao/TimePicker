...
public class TimePickerView extends FrameLayout {
    ...
    private void init(Context mContext)
    {
        ...
        //底部控件的尺寸
        FrameLayout.LayoutParams mParentParams = new FrameLayout.LayoutParams(LayoutParams.MATCH_PARENT,mViewHeight);
        ...
        LinearLayout.LayoutParams mWheelParams = new LinearLayout.LayoutParams(0,LinearLayout.LayoutParams.MATCH_PARENT);
